...
public class DEditDSC2 extends AppCompatDialogFragment {
    ...
    public interface DialogEditDSC2Listener{
        void applyTextDSC2(String input);
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.edit_dsc2, null);
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Save", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        String inputText = input_dsc2.getText().toString();
                        Log.d(TAG, "onClick: DECN" + inputText);
                        listener.applyTextDSC2(inputText);
                ...
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        com.example.look.snp.fragments.dialogfragments.DEditDSC2.this.getDialog().cancel();
                    }
                });
        input_dsc2 = view.findViewById(R.id.input_dsc2);
